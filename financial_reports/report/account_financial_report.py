...
class AccountType(models.Model):
    ...
    report_seq = fields.Integer(string="Sequence For Financial Report", copy=False)
...
class account_financial_report(models.Model):
    ...
    report_side = fields.Selection([('left','Left'),('right','Right')], string='Report Side', default='left')
    ...
    def onchange_parent_id(self):
        if self.parent_id:
            self.report_side = self.parent_id.report_side
    
    @api.onchange('report_side')
    def onchange_report_side(self):
        if self.report_side and self.parent_id  and self.parent_id.parent_id:
            if self.parent_id.report_side != self.report_side:
                self.report_side = self.parent_id.report_side
