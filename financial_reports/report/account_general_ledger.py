...
class ReportGeneralLedger(models.AbstractModel):
    _name = 'report.financial_reports.report_generalledger'

    def _get_account_move_entry(self, accounts, init_balance, sortby, display_account, data):
        """
        :param:
        ...
        wiz = self.env[data['context']['active_model']].browse(data['context']['active_id'])          
    ...
    def _get_report_values(self, docids, data=None):
        ...
        accounts_res = self.with_context(data['form'].get('used_context',{}))._get_account_move_entry(accounts, init_balance, sortby, display_account, data)
        return {
            'doc_ids': docids,
